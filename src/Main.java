...
public class Main {
    public static void main(String[] args) {
        ...
        st.addStudent(students, new Student("BH002","Nguyen Trung Nam", 9.5));

        st.addStudent(students, new Student("BH003","Nguyen Trung An", 6.0));
        ...
        edit.editStudent(students, 1, new Student("BH009", "Nam", 4));
        System.out.println("********* List data of students after updated **********");
        for (Student s : students){
            System.out.println("ID = " + s.id +" , fullName = " + s.fullName + " , mark = " + s.mark + " , rank = " + s.rank);
        }
        System.out.println("********* Edit Student By Id **********");
        edit.editStudentById(students, "BH009", new Student("BH009", "An", 9.0));
